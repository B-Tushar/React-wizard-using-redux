                    ...
                    <div className="panel-body">
                     <form className="form-horizontal">
                        <div className="form-group form-group-md">
                           <div className="row">
                                <label style={{ marginLeft:'15%'}}>Name:</label> {this.props.fieldValues.name}<br/>
...
const mapStateToProps = (state, props) => {return {fieldValues:state}}

const mapDispatchToProps = (dispatch) => {return bindActionCreators({nextStep,prevStep},dispatch)}
