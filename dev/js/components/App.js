...
//import {ProgressBar,bsStyle,text,variation} from 'react-bootstrap';
			 ...
			 <div className="container">
                       ...
                       <div className="row">
                           <div className="col-md-06" style={{marginLeft:"14px"}}>
                            ...
                            <div className="col-md-06" style={{marginLeft:"14px"}}>
					       		<progress className="progress" value={this.props.stateInfo.currentStep / 3 * 100} max="100" style={style}></progress>
                            </div>
					   </div>
					   <div className="row">
				       		{this.showStep()}
